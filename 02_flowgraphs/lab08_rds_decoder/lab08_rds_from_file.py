...
# Title: Lab 08b - RDS Decoder from a Recorded IQ File (no hardware)
# Author: SignalSDR Pro Lab
# Description: The same RDS decoder, fed from disk - use this to develop and to verify against a known signal
...
import lab08_rds_from_file_rds_decoder as rds_decoder  # embedded python block
import sip



class lab08_rds_from_file(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 08b - RDS Decoder from a Recorded IQ File (no hardware)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 08b - RDS Decoder from a Recorded IQ File (no hardware)")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab08_rds_from_file")
        ...
        self.rec_file = rec_file = '/tmp/rds_test_2Msps_fc32.iq'
        ...
        self.connect((self.throttle, 0), (self.xlating_fm, 0))
...
def main(top_block_cls=lab08_rds_from_file, options=None):
