...
class lab10_dvbt2_generate(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 10a - DVB-T2 Signal Generator (to file, no RF)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 10a - DVB-T2 Signal Generator (to file, no RF)")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab10_dvbt2_generate")
        ...
        self.capture_seconds = capture_seconds = 3.0
        ...
        self.iq_sink.set_unbuffered(False)
        self.head = blocks.head(gr.sizeof_gr_complex*1, (int(samp_rate * capture_seconds)))
        ...
        self.connect((self.head, 0), (self.iq_sink, 0))
        ...
        self.connect((self.tx_scale, 0), (self.head, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.head.set_length((int(self.samp_rate * self.capture_seconds)))
    ...
    def set_iq_file(self, iq_file):
        ...
        self.iq_sink.open(self.iq_file)
...
def main(top_block_cls=lab10_dvbt2_generate, options=None):
